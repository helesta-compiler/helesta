...
ActionTransition::ActionTransition(ATNState *target, size_t ruleIndex)
    : Transition(TransitionType::ACTION, target), ruleIndex(ruleIndex),
      actionIndex(INVALID_INDEX), isCtxDependent(false) {}

ActionTransition::ActionTransition(ATNState *target, size_t ruleIndex,
                                   size_t actionIndex, bool isCtxDependent)
    : Transition(TransitionType::ACTION, target), ruleIndex(ruleIndex),
      actionIndex(actionIndex), isCtxDependent(isCtxDependent) {}
