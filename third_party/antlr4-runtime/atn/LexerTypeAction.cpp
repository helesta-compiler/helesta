...
LexerTypeAction::LexerTypeAction(int type)
    : LexerAction(LexerActionType::TYPE, false), _type(type) {}

void LexerTypeAction::execute(Lexer *lexer) const { lexer->setType(getType()); }
